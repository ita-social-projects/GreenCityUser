...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   * @return ResponseEntity which contains details about exception and 400 status code
   */
   ...
   * @return {@link ResponseEntity} contains http status and body with exception message.
   */
   ...
   * @param exception which is being intercepted
   * @param request   contains details about occurred exception
   * @return ResponseEntity which contains details about exception and 401 status code
   */
